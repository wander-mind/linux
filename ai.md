...
What if i'm being preasured even more by this bot to buy Dave Mustaine tickets, because it knows so much about me, and maybe because I keep the entire discography in MP3 and FLAC on my PC, and watch some music vides from time to time? What if Dave's PC knows he is dying and that maybe this will be he's last concert, and now OpenAI is pushing this concert even more on ppl? What if these things are not just offline, private, and personal slave helpers, but a mesh of billions of ppl's PCs, all manipulated in a trans or dance of sort into **Big Tech's** own personal interests, so we become too poluted to realise what's going on outside, and manipulate us into voting in their interest, untill one day, bit by bit, like the frog in boiling water, lose all our freedomes, so that they can run off with all the money?? Too deep? Well, it's technically possible, like it was technically possible for the CIA to spy on most humans on the earth in real time 12 years ago, but they said that they will neeeever do such a thing - belive us, freedome fighters, we are just spying on the terrorists, that's all.
